...
// export const CreateImage = (record: CloudTrail.Record): Tables.Resource => {
//   console.log('CreateImage Response:', record.responseElements);

//   return {
//     UserName: defaultTo(record.userIdentity.userName, record.userIdentity.sessionContext.sessionIssuer.userName),
//     ResourceId: record.responseElements.imageId,
//     ResourceName: record.responseElements.imageId,
