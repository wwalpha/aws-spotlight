...
describe(EVENT_SOURCE, () => {
  test('Multiple records', async () => {
    ...
    const ec2Resource = await getResource('arn:aws:ec2:ap-northeast-1:999999999999:instance/i-0fc5d99558e8357e8');
    const rdsResource = await getResource('arn:aws:rds:ap-northeast-1:999999999999:cluster:database-4');
  ...
  test.skip('Resource not exist', async () => {
