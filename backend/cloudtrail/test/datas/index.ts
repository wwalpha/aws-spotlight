...
export { default as BATCH_CreateComputeEnvironment } from './simple/BATCH_CreateComputeEnvironment.json';
export { default as BATCH_DeleteComputeEnvironment } from './simple/BATCH_DeleteComputeEnvironment.json';

export { default as CODEBUILD_CreateProject } from './simple/CODEBUILD_CreateProject.json';
export { default as CODEBUILD_DeleteProject } from './simple/CODEBUILD_DeleteProject.json';

export { default as CODEDEPLOY_CreateApplication } from './simple/CODEDEPLOY_CreateApplication.json';
export { default as CODEDEPLOY_DeleteApplication } from './simple/CODEDEPLOY_DeleteApplication.json';

export { default as CONNECT_CreateInstance } from './simple/CONNECT_CreateInstance.json';
export { default as CONNECT_DeleteInstance } from './simple/CONNECT_DeleteInstance.json';

export { default as CLOUDFORMATION_CreateStack } from './simple/CLOUDFORMATION_CreateStack.json';
export { default as CLOUDFORMATION_DeleteStack } from './simple/CLOUDFORMATION_DeleteStack.json';

export { default as COGNITOIDP_CreateUserPool } from './cognito/COGNITO-IDP_CreateUserPool.json';
export { default as COGNITOIDP_DeleteUserPool } from './cognito/COGNITO-IDP_DeleteUserPool.json';

export { default as COGNITOIDENTITY_CreateIdentityPool } from './cognito/COGNITO-IDENTITY_CreateIdentityPool.json';
export { default as COGNITOIDENTITY_DeleteIdentityPool } from './cognito/COGNITO-IDENTITY_DeleteIdentityPool.json';
