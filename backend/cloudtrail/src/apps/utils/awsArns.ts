export const ResourceARNs = {
  ...
  // appstream fleet
  APPSTREAM_Fleet: (region: string, account: string, id: string) =>
    `arn:aws:appstream:${region}:${account}:fleet/${id}`,
  ...
  NETWORKMONITOR_Monitor: (region: string, account: string, id: string) =>
    `arn:aws:networkmonitor:${region}:${account}:monitor/${id}`,
  ...
  // fsx
  FSX_FileSystem: (region: string, account: string, id: string) => `arn:aws:fsx:${region}:${account}:file-system/${id}`,
  ...
  // ec2 route table
  EC2_RouteTable: (region: string, account: string, id: string) => `arn:aws:ec2:${region}:${account}:route-table/${id}`,
  ...
  // ec2 vpn gateway
  EC2_VpnGateway: (region: string, account: string, id: string) => `arn:aws:ec2:${region}:${account}:vpn-gateway/${id}`,
